...
var LayoutFooterService = (function () {
    function LayoutFooterService(httpInterceptorService) {
        this.httpInterceptorService = httpInterceptorService;
    }
    LayoutFooterService.prototype.addContactsAll = function (params) {
        console.log(params);
    ...
    LayoutFooterService = __decorate([
        Injectable(),
        __metadata("design:paramtypes", [HttpInterceptorService])
    ], LayoutFooterService);
    return LayoutFooterService;
}());
export { LayoutFooterService };
